...
public final class ClassUtils {
    ...
    private static final List<String> PROXY_CLASS_NAMES =
        Arrays.asList("net.sf.cglib.proxy.Factory", "org.springframework.cglib.proxy.Factory",
    ...
    public static <T> T newInstance(Class<T> clazz) {
        try {
            ...
            throw ExceptionUtils.app("实例化对象时出现错误,请尝试给 %s 添加无参的构造方法", e, clazz.getName());
        }
    }
    ...
    public static Class<?> toClassConfident(String name) {
        try {
            ...
            throw ExceptionUtils.app("找不到指定的class！请仅在明确确定会有 class 的时候，调用该方法", e);
        }
    }
